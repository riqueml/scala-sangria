...
package object models {
    ...
    case class User(id:Int, name:String, email:String, pass:String, createdAt:DateTime = DateTime.now) extends Identifiable
    ...
    case class AuthProviderSignupData(auth: AuthProviderEmail)
